...
public class Contacto implements Modelo {
	...
	/*
	 * Relación One to Many Se especifica en la clase correspondiente a Many,
	 * para después solo usar el mapped by en la clase correspondiente a One.
	 * 
	 * @ManyToOne
	 * 
	 ...
	 * Ejemplo en:
	 * https://stackoverflow.com/questions/11244569/what-is-referencedcolumnname
	 * -used-for-in-jpa
	 */
