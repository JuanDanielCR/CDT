 ...
 * 
 */
public class ActionSupportCDT extends ActionSupport {
	...
	/*
	 * Nombre del result para deleteConfirm
	 */
	protected static final String DELETECONFIRM = "deleteConfirm";
	...
	protected String validarArchivoSession(Archivo archivo,
		...
		if (!fieldErrors.keySet().contains(fieldName)) {
			...
			SessionManager.put(sessionFileName, sessionFile);
