...
public class Aspirante implements Modelo {
	 ...
	 * Solo se pueden crear SequenceGenerators para ints, no varchars
	 */
	@Id
	...
	@Validations(requiredStrings = {
			@RequiredStringValidator(type = ValidatorType.FIELD, fieldName = "model.nombre", message = "${getText('MSG40')}") }, stringLengthFields = {
					@StringLengthFieldValidator(maxLength = "100", message = "${getText('MSG41')}") })
	...
	@Validations(requiredStrings = {
			@RequiredStringValidator(type = ValidatorType.FIELD, message = "${getText('MSG40')}") }, stringLengthFields = {
					// @StringLengthFieldValidator(minLength = "1", message =
					// "MS"),
					@StringLengthFieldValidator(maxLength = "100", message = "${getText('MSG41')}") })
	...
	@Validations(requiredStrings = {
			@RequiredStringValidator(type = ValidatorType.FIELD, message = "${getText('MSG40')}") }, stringLengthFields = {
					@StringLengthFieldValidator(maxLength = "18", message = "${getText('MSG41',{getText('18'),getText('Por fa')})}") })
